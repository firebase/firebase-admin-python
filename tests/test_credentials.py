...
class TestCertificate:
    ...
    @pytest.mark.parametrize(
        "file_name,error", invalid_certs.values(), ids=list(invalid_certs)
    )
    ...
    def _verify_credential(self, credential):
        ...
        assert (
            ...
            == "mock-email@mock-project.iam.gserviceaccount.com"
        )
...
class TestApplicationDefault:
    ...
    @pytest.mark.parametrize(
        "app_default", [testutils.resource_filename("non_existing.json")], indirect=True
    )
