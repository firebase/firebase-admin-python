...
- [added] The [`initialize_app()`](/docs/reference/admin/node/admin#.initializeApp)
...
- [added] The [`db.Reference.get()`](/docs/reference/admin/python/firebase_admin.db#reference)
...
- [added] A new [`instance_id`](/docs/reference/admin/python/firebase_admin.instance_id)
...
### Authentication
- [added] Added the
  [`list_users()`](/docs/reference/admin/python/firebase_admin.auth#list_users)
...
- [added] Added the
  [`set_custom_user_claims()`](/docs/reference/admin/python/firebase_admin.auth#set_custom_user_claims)
...
- [changed] Updated the `start_at()`, `end_at()` and `equal_to()` methods of
  the [`db.Query`](/docs/reference/admin/python/firebase_admin.db#query) class
  so they can accept empty string arguments.

# v2.5.0

- [added] A new [`Firestore` API](/docs/reference/admin/python/firebase_admin.firestore)
...
- [added] The [`db.Reference`](/docs/reference/admin/python/firebase_admin.db#reference)
...
- [added] The options dictionary passed to
  [`initialize_app()`](/docs/reference/admin/python/firebase_admin#initialize_app)
...
- [added] You can now get the ETag value of a database reference by passing
  ...
  [`db.Reference`](/docs/reference/admin/python/firebase_admin.db#reference)
  object.
- [added] The [`db.Reference`](/docs/reference/admin/python/firebase_admin.db#reference)
...
- [added] A new [Cloud Storage API](/docs/reference/admin/python/firebase_admin.storage)
...
- [added] A new user management API that allows provisioning and managing
  ...
  to the [`firebase_admin.auth`](/docs/reference/admin/python/firebase_admin.auth)
  module.
...
- [changed] Constructors of
  [`Certificate`](/docs/reference/admin/python/firebase_admin.credentials#certificate) and
  [`RefreshToken`](/docs/reference/admin/python/firebase_admin.credentials#refreshtoken)
...
- [added] A new [database API](/docs/reference/admin/python/firebase_admin.db)
