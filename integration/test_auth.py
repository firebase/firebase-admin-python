...
def test_create_oidc_provider_config(oidc_provider):
    ...
    assert oidc_provider.response_type.id_token == True
    assert oidc_provider.response_type.code == False
    assert oidc_provider.client_secret == None
...
def test_get_oidc_provider_config(oidc_provider):
    ...
    assert provider_config.response_type.id_token == True
    assert provider_config.response_type.code == False
    assert provider_config.client_secret == None
...
def test_update_oidc_provider_config():
    ...
    try:
        ...
        assert provider_config.response_type.id_token == False
        assert provider_config.response_type.code == True
