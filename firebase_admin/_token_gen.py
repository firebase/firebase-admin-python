...
class _JWTVerifier:
    ...
    def __init__(
        ...
        *,
        ...
        cert_url: str,
        issuer: str,
        invalid_token_error: Callable[[str, Optional[Exception]], exceptions.FirebaseError],
        expired_token_error: Callable[[str, Optional[Exception]], exceptions.FirebaseError],
        **kwargs: Any,
    ) -> None:
    ...
    def verify(
        ...
        if error_message:
            raise self._invalid_token_error(error_message, None)
        ...
        try:
            ...
            if 'Token expired' in str(error):
                raise self._expired_token_error(str(error), error)
