...
_LINKS_URL = 'https://firebasedynamiclinks.googleapis.com/v1/{1}/linkStats?durationDays={2}'
...
EventStats = namedtuple('EventStats',  ['platform', 'event_type', 'count'])
...
def get_link_stats(short_link, stat_options): 
  pass
...
class _LinksService(object):
    ...
    def __init__(self, app):
        self._client = _http_client.JsonHttpClient(
          credential=app.credential.get_credential(), base_url=_LINKS_SERVICE_URL)
