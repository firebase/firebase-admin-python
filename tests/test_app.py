...
env_options_test_cases = [
    ...
    EnvOptionsTestCase(name='Environment var set to file but ignored, initialized with options dict',
                       config_json='firebase_config.json',
                       init_options={'storageBucket': 'bucket1'},
                       want_options={'storageBucket': 'bucket1'}),
    EnvOptionsTestCase(name='Environment var set to string json but ignored, initialized with options dict',
                       config_json='{"storageBucket": "hipster-chat.appspot.mock"}',
                       init_options={'storageBucket': 'bucket1'},
                       want_options={'storageBucket': 'bucket1'}),
    EnvOptionsTestCase(name='Environment var set to json file and used, initialized with no options dict',
                       config_json='firebase_config.json',
                       init_options=None,
    ...
    EnvOptionsTestCase(name='Environment var set to json string and used, initialized with no options dict',
    ...
    EnvOptionsTestCase(name='Invalid key in json file is ignored, the rest of the values are used',
                       ...
                       init_options=None,
                       want_options={'projectId': 'hipster-chat-mock'}),
    EnvOptionsTestCase(name='Environment var set to json file but ignored, initialized with empty options dict',
                       config_json='firebase_config.json',
                       init_options={},
                       want_options={}),
    EnvOptionsTestCase(name='Environment var set to json file but ignored, initialized with empty options dict',
    ...
    EnvOptionsTestCase(name='Environment variable set to json string with some options set',
                       ...
                       want_options={'databaseURL': 'https://hipster-chat.firebaseio.mock',
                                     'projectId': 'hipster-chat-mock'}),
    EnvOptionsTestCase(name='Environment var set to json file but ignored, initialized with options dict',
                       config_json='firebase_config_partial.json',
                       init_options={'projectId': 'pid1-mock',
                                     'storageBucket': 'sb1-mock'},
                       want_options={'projectId': 'pid1-mock',
                                     'storageBucket': 'sb1-mock'}),
    EnvOptionsTestCase(name='Environment var set to string json but ignored, initialized with full options dict',
                       config_json='firebase_config.json',
