...
@pytest.fixture(
    params=[Cert(), RefreshToken(), ExplicitAppDefault(), ImplicitAppDefault()],
...
EnvOptionsTestCase = namedtuple(
    "EnvOptionsTestCase", "name, config_json, init_options, want_options"
)
env_options_test_cases = [
    EnvOptionsTestCase(
        name="Environment var not set, initialized with an empty options dict",
        config_json=None,
        init_options={},
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment var empty, initialized with an empty options dict",
        config_json="",
        init_options={},
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment var not set, initialized with no options dict",
        config_json=None,
        init_options=None,
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment empty, initialized with no options dict",
        config_json="",
        init_options=None,
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment var not set, initialized with options dict",
        config_json=None,
        init_options={"storageBucket": "bucket1"},
        want_options={"storageBucket": "bucket1"},
    ),
    EnvOptionsTestCase(
        name="Environment var set to file but ignored, initialized with options",
        config_json="firebase_config.json",
        init_options={"storageBucket": "bucket1"},
        want_options={"storageBucket": "bucket1"},
    ),
    EnvOptionsTestCase(
        name="Environment var set to json but ignored, initialized with options",
        config_json='{"storageBucket": "hipster-chat.appspot.mock"}',
        init_options={"storageBucket": "bucket1"},
        want_options={"storageBucket": "bucket1"},
    ),
    EnvOptionsTestCase(
        name="Environment var set to file, initialized with no options dict",
        config_json="firebase_config.json",
        init_options=None,
        want_options={
    ...
    EnvOptionsTestCase(
        name="Environment var set to json string, initialized with no options dict",
    ...
    EnvOptionsTestCase(
        name="Invalid key in json file is ignored, the rest of the values are used",
    ...
    EnvOptionsTestCase(
        name="Environment var set to file but ignored, init empty options dict",
        config_json="firebase_config.json",
        init_options={},
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment var set to string but ignored, init empty options dict",
        config_json='{"projectId": "hipster-chat-mock"}',
        init_options={},
        want_options={},
    ),
    EnvOptionsTestCase(
        name="Environment variable set to json file with some options set",
    ...
    EnvOptionsTestCase(
        name="Environment variable set to json string with some options set",
    ...
    EnvOptionsTestCase(
        name="Environment var set to json file but ignored, init with options dict",
        config_json="firebase_config_partial.json",
        init_options={"projectId": "pid1-mock", "storageBucket": "sb1-mock"},
        want_options={"projectId": "pid1-mock", "storageBucket": "sb1-mock"},
    ),
    EnvOptionsTestCase(
        name="Environment var set to file but ignored, init with full options dict",
        config_json="firebase_config.json",
        init_options={
...
class TestFirebaseApp:
    ...
    @pytest.mark.parametrize(
        "bad_file_name",
        ["firebase_config_empty.json", "firebase_config_invalid.json", "no_such_file"],
    )
    ...
    def test_app_init_with_default_config(self, env_test_case):
        app = firebase_admin.initialize_app(
            CREDENTIAL, options=env_test_case.init_options
        )
    ...
    def test_no_project_id(self):
        def evaluate():
            app = firebase_admin.initialize_app(
                testutils.MockCredential(), name="myApp"
            )
    ...
    @pytest.mark.parametrize("args", [(), ("myApp",)], ids=["DefaultApp", "CustomApp"])
