...
class HttpxRetry:
    ...
    def is_retryable_response(self, response: httpx2.Response) -> bool:
    ...
    def get_retry_after(self, response: httpx2.Response) -> float | None:
    ...
    async def sleep(self, response: httpx2.Response) -> None:
...
class HttpxRetryTransport(httpx2.AsyncBaseTransport):
    ...
    def __init__(self, retry: HttpxRetry = DEFAULT_RETRY, **kwargs: Any) -> None:
        ...
        self._wrapped_transport = httpx2.AsyncHTTPTransport(**transport_kwargs)
    ...
    async def _dispatch_with_retry(
            self,
            request: httpx2.Request,
            dispatch_method: Callable[[httpx2.Request], Coroutine[Any, Any, httpx2.Response]]
    ) -> httpx2.Response:
